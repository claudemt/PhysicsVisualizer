function app = launch_waveguide_studio(project_root)
%LAUNCH_WAVEGUIDE_STUDIO Build the main GUI window.
...
create_metal_guides_tab(app.tab_group, project_root);
create_planar_dielectric_tab(app.tab_group, project_root);
create_cylindrical_dielectric_tab(app.tab_group, project_root);
