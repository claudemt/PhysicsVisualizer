...
tab_builders = { ...
    @create_fourier_studio_tab, ...
    @create_wave_optics_tab, ...
    @create_imaging_tab, ...
    @create_interference_tab, ...
    @create_ray_optics_tab, ...
    @create_tomography_tab};

launch_gui_studio(project_root, tab_builders, 'StudioName', 'Unified Optics Studio');
end
