...
fcGHz = order * C.c0 / (2 * d * sqrt(n1^2 - n2^2)) / 1e9;
titleText = sprintf('$\\mathrm{%s}_{%d},\\ f=%.4g\\ \\mathrm{GHz},\\ f_{\\mathrm{c}}=%.4g\\ \\mathrm{GHz}$', ...
    modeType, order, freqGHz, fcGHz);
R = struct('x', X/d, 'z', Z/d, 'F', F, 'V', V, 'u', u, 'w', w, ...
